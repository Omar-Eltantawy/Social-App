...
export const userRegister= createAsyncThunk('userSlice/userRegister',async (values: UserI, thunkAPI) => {
    try {
...
export const userLogin= createAsyncThunk('userSlice/userLogin',async (values: UserI, thunkAPI) => {
    try {
...
export const getUserData= createAsyncThunk('userSlice/getUserData',async (_:void,thunkAPI) => {
    try {
...
export const updateUserPhoto= createAsyncThunk('userSlice/updateUserPhoto',async (formData:FormData,thunkAPI) => {
    try {
...
export const getUserPosts= createAsyncThunk('userSlice/getUserPosts',async (id:string|undefined,thunkAPI) => {
    try {
...
export const deleteUserSpecificPost= createAsyncThunk('userSlice/deleteUserSpecificPost',async (id:string|undefined,thunkAPI) => {
    try {
...
export const userslice= createSlice({
    ...
    extraReducers:(builder)=>{
        ...
        //Handle deleting user post
        builder.addCase(deleteUserSpecificPost.pending, (state) => {
            state.loading=true;
        })
